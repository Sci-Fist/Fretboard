...
async function playTab(tabData) {
    ...
    function initializeAudioContext() {
        if (!audioContext) {
            ...
            try {
                ...
                console.log('audio.js: AudioContext initialized successfully. State:', audioContext.state);
            } catch (e) {
    ...
    if (!initializeAudioContext()) { // Initialize and check for success
    ...
    if (audioContext.state === 'suspended') {
        ...
        try {
            console.log('audio.js: AudioContext state before resume:', audioContext.state);
            await audioContext.resume();
            console.log('audio.js: AudioContext resumed successfully. State after resume:', audioContext.state);
        } catch (err) {
